<form ng-model="loginForm" ng-controller="UserController" ng-submit="create()"
    ...
    <div class="form-group">
							...
							<div class="col-md-3">
								<input type="text" class="form-control" ng-model="gender" placeholder="Gender">
							</div>
						</div>
						<div class="form-group">
							
							<div class="col-md-3">
								<input type="date" class="form-control" ng-model="dob" placeholder="Date of birth">
							</div>
						</div>
						<div class="form-group">

							<div class="col-md-3">
								<input type="text" class="form-control" ng-model="education" placeholder="Education">
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-md-3">
								<input type="text" class="form-control" ng-model="work" placeholder="Work">
							</div>
						</div>
